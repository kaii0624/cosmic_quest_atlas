...
const CATALOG_LESSON_CONTENT = {
  ...
  "distant-galaxy": {
    ...
    quiz: [
      { q: "遠い銀河ほど赤方偏移が大きいことは何を示すか。", choices: ["ア　宇宙が膨張していること", "イ　銀河が冷えていること", "ウ　地球が中心であること", "エ　星が増えていること"], answer: "正解：ア　宇宙が膨張していること", explain: "距離が大きいほど速く遠ざかる関係は、宇宙全体の膨張を意味する。" },
      { q: "光源が遠ざかるとスペクトルはどうずれるか。", choices: ["ア　赤い側（長波長）にずれる", "イ　青い側にずれる", "ウ　ずれない", "エ　消える"], answer: "正解：ア　赤い側（長波長）にずれる", explain: "遠ざかると波長がのびて赤くずれる（赤方偏移）。" },
      { q: "距離と赤方偏移の関係はどれか。", choices: ["ア　遠い銀河ほど赤方偏移が大きい", "イ　遠い銀河ほど小さい", "ウ　距離とは無関係", "エ　近い銀河ほど大きい"], answer: "正解：ア　遠い銀河ほど赤方偏移が大きい", explain: "距離が大きいほど赤方偏移も大きい（ハッブルの関係）。" }
    ]
  },
  "sirius-b": {
    ...
    quiz: [
      { q: "シリウスBのような白色矮星の特徴はどれか。", choices: ["ア　小さな半径に大きな質量をもつ高密度天体", "イ　巨大で低密度の星", "ウ　惑星の一種", "エ　彗星の核"], answer: "正解：ア　小さな半径に大きな質量をもつ高密度天体", explain: "地球ほどの大きさに太陽級の質量をもつ、高温・高密度の白色矮星。" },
      { q: "シリウスBを支えている力はどれか。", choices: ["ア　電子の縮退圧", "イ　核融合の光", "ウ　磁石の力", "エ　風の力"], answer: "正解：ア　電子の縮退圧", explain: "通常の圧力では潰れを支えられず、電子の縮退圧が支える。" },
      { q: "白色矮星は恒星のどんな姿か。", choices: ["ア　恒星の終末形態のひとつ", "イ　生まれたての星", "ウ　惑星", "エ　彗星"], answer: "正解：ア　恒星の終末形態のひとつ", explain: "燃え尽きた後に残る、高密度の終末形態のひとつ。" }
    ]
  },
  "antares": {
    ...
    quiz: [
      { q: "アンタレスが赤いのに明るい理由はどれか。", choices: ["ア　半径が非常に大きいから", "イ　距離が極端に近いから", "ウ　表面が高温だから", "エ　青い光を出すから"], answer: "正解：ア　半径が非常に大きいから", explain: "赤色超巨星は表面温度が低い（赤い）が、巨大な表面積から多くの光を出す。" },
      { q: "アンタレスが赤いのはなぜか。", choices: ["ア　表面温度が低いから", "イ　遠いから", "ウ　小さいから", "エ　高速自転だから"], answer: "正解：ア　表面温度が低いから", explain: "膨れあがって表面が冷え、低温の赤い光を放つ。" },
      { q: "アンタレスはどんな星の進化段階か。", choices: ["ア　大質量星の晩年（赤色超巨星）", "イ　生まれたての原始星", "ウ　白色矮星", "エ　惑星"], answer: "正解：ア　大質量星の晩年（赤色超巨星）", explain: "大質量星が晩年に進む赤色超巨星の代表例。" }
    ]
  },
  "aldebaran": {
    ...
    quiz: [
      { q: "アルデバランのような赤色巨星はどんな段階か。", choices: ["ア　主系列を終えて外層がふくらんだ段階", "イ　生まれたばかりの段階", "ウ　ブラックホールになった段階", "エ　惑星になった段階"], answer: "正解：ア　主系列を終えて外層がふくらんだ段階", explain: "中心の水素を使い終えて主系列を離れ、膨張・低温化した巨星。" },
      { q: "赤色巨星が赤く見えるのはなぜか。", choices: ["ア　ふくらんで表面が冷えたから", "イ　高温だから", "ウ　近いから", "エ　高速自転だから"], answer: "正解：ア　ふくらんで表面が冷えたから", explain: "外層がふくらんで表面温度が下がり、赤くなる。" },
      { q: "太陽はいずれどうなると考えられるか。", choices: ["ア　主系列を終えて巨星にふくらむ", "イ　彗星になる", "ウ　直接ブラックホールになる", "エ　何も変わらない"], answer: "正解：ア　主系列を終えて巨星にふくらむ", explain: "太陽程度の星も、主系列後に赤色巨星へと進化する。" }
    ]
  },
  "capella": {
    ...
    quiz: [
      { q: "連星カペラから直接測れる量はどれか。", choices: ["ア　星の質量", "イ　星の神話", "ウ　地球の年齢", "エ　彗星の数"], answer: "正解：ア　星の質量", explain: "連星の軌道（周期と大きさ）から、ケプラーの法則で恒星の質量が求められる。" },
      { q: "カペラの正体はどれか。", choices: ["ア　二つの巨星からなる連星", "イ　単独の惑星", "ウ　彗星", "エ　銀河"], answer: "正解：ア　二つの巨星からなる連星", explain: "一点に見えるが、進化した二つの巨星が回り合う連星。" },
      { q: "連星の質量を求めるのに使う法則はどれか。", choices: ["ア　ケプラーの法則", "イ　オームの法則", "ウ　パスカルの原理", "エ　てこの原理"], answer: "正解：ア　ケプラーの法則", explain: "回り合う周期と軌道の大きさから、ケプラーの法則で質量が出る。" }
    ]
  },
  "procyon": {
    ...
    quiz: [
      { q: "プロキオンの伴星はどうやって予測されたか。", choices: ["ア　主星の位置の揺れから", "イ　主星の色から", "ウ　彗星の尾から", "エ　月食から"], answer: "正解：ア　主星の位置の揺れから", explain: "見えない伴星の重力で主星がふらつき、その揺れから存在が予測された。" },
      { q: "プロキオンの伴星の正体はどれか。", choices: ["ア　暗い白色矮星", "イ　明るい巨星", "ウ　惑星の環", "エ　彗星"], answer: "正解：ア　暗い白色矮星", explain: "予測された伴星は、のちに暗い白色矮星として確認された。" },
      { q: "重力運動から見つけられるのはどれか。", choices: ["ア　見えない伴星の存在", "イ　星座の神話", "ウ　地球の自転", "エ　彗星の名前"], answer: "正解：ア　見えない伴星の存在", explain: "主星のふらつき（重力運動）から、見えない伴星を見つけられる。" }
    ]
  },
  "pollux": {
    ...
    quiz: [
      { q: "ポルックスが示す進化段階はどれか。", choices: ["ア　太陽級の星が主系列後にふくらんだ巨星", "イ　生まれたての原始星", "ウ　超巨大ブラックホール", "エ　彗星"], answer: "正解：ア　太陽級の星が主系列後にふくらんだ巨星", explain: "太陽に近い質量の星が主系列を終え、膨張・低温化した橙色巨星。" },
      { q: "ポルックスは何色の巨星か。", choices: ["ア　橙色", "イ　青色", "ウ　純白", "エ　緑色"], answer: "正解：ア　橙色", explain: "外層がふくらみ表面が冷えて橙色になった巨星。" },
      { q: "ポルックスからわかるのはどれか。", choices: ["ア　太陽程度の星の主系列後の進化", "イ　ブラックホールの作り方", "ウ　彗星の軌道", "エ　銀河の衝突"], answer: "正解：ア　太陽程度の星の主系列後の進化", explain: "太陽に近い質量の星がたどる主系列後の進化を示す。" }
    ]
  },
  "altair": {
    ...
    quiz: [
      { q: "アルタイルが扁平な形をしている理由はどれか。", choices: ["ア　高速で自転しているから", "イ　とても低温だから", "ウ　連星だから", "エ　彗星だから"], answer: "正解：ア　高速で自転しているから", explain: "速い自転の遠心力で赤道方向にふくらみ、扁平な形になる。" },
      { q: "高速自転でふくらむのは星のどの部分か。", choices: ["ア　赤道", "イ　北極だけ", "ウ　中心核", "エ　ふくらまない"], answer: "正解：ア　赤道", explain: "遠心力で赤道方向がふくらみ、扁平になる。" },
      { q: "ふくらんだ赤道の表面温度はどうなるか。", choices: ["ア　極より低くなる", "イ　極より高くなる", "ウ　変わらない", "エ　ゼロになる"], answer: "正解：ア　極より低くなる", explain: "赤道は重力が弱まり温度が下がる（重力減光）。" }
    ]
  },
  "delta-cephei": {
    ...
    quiz: [
      { q: "ケフェイド変光星で距離を測るのに使う関係はどれか。", choices: ["ア　周期と本当の明るさの関係", "イ　色と質量の関係", "ウ　自転と磁場の関係", "エ　名前と神話の関係"], answer: "正解：ア　周期と本当の明るさの関係", explain: "周期光度関係から本当の明るさが分かり、見かけと比べて距離が求められる。" },
      { q: "ケフェイドで周期が長い星はどうか。", choices: ["ア　本当に明るい", "イ　本当に暗い", "ウ　明るさと無関係", "エ　光らない"], answer: "正解：ア　本当に明るい", explain: "周期が長いほど本当の明るさが大きい（周期光度関係）。" },
      { q: "周期から本当の明るさが分かると何ができるか。", choices: ["ア　距離を測れる", "イ　質量だけ分かる", "ウ　神話が分かる", "エ　何もできない"], answer: "正解：ア　距離を測れる", explain: "本当の明るさと見かけを比べて距離が求められる。" }
    ]
  },
  "polaris-cepheid": {
    ...
    quiz: [
      { q: "ポラリス（北極星）のもう一つの顔はどれか。", choices: ["ア　ケフェイド変光星", "イ　ブラックホール", "ウ　彗星", "エ　銀河"], answer: "正解：ア　ケフェイド変光星", explain: "北極付近にありながら、周期的に変光するケフェイドでもある。" },
      { q: "ポラリスが方位の基準になるのはなぜか。", choices: ["ア　天の北極近くでほぼ動かないから", "イ　最も明るいから", "ウ　彗星だから", "エ　高速自転だから"], answer: "正解：ア　天の北極近くでほぼ動かないから", explain: "天の北極近くにあり、一晩中ほぼ同じ場所に見える。" },
      { q: "近傍ケフェイドのポラリスが役立つのはどれか。", choices: ["ア　周期光度関係の較正", "イ　彗星の予報", "ウ　月食の予測", "エ　地震の予知"], answer: "正解：ア　周期光度関係の較正", explain: "近いので距離が独立に求めやすく、距離尺度の較正に使える。" }
    ]
  },
  "rr-lyrae": {
    ...
    quiz: [
      { q: "こと座RR星が距離測定に使えるのはなぜか。", choices: ["ア　同型の本当の明るさがほぼ一定だから", "イ　色が毎回変わるから", "ウ　動かないから", "エ　彗星だから"], answer: "正解：ア　同型の本当の明るさがほぼ一定だから", explain: "ほぼ一定の光度をもつ標準光源なので、見かけの暗さから距離が分かる。" },
      { q: "こと座RR星の変光周期はどんな特徴か。", choices: ["ア　短く規則的", "イ　とても長い", "ウ　不規則でばらばら", "エ　変光しない"], answer: "正解：ア　短く規則的", explain: "短い周期で規則正しく明滅する変光星。" },
      { q: "RR型変光星はどんな天体の距離測定に向くか。", choices: ["ア　球状星団など古い星集団", "イ　彗星", "ウ　太陽の黒点", "エ　惑星の環"], answer: "正解：ア　球状星団など古い星集団", explain: "古い恒星集団に多く、その距離を測る標準光源になる。" }
    ]
  },
  "barnards-star": {
    ...
    quiz: [
      { q: "バーナード星の大きな固有運動が示すことはどれか。", choices: ["ア　恒星も天球上を動いていること", "イ　星が完全に静止していること", "ウ　地球が動かないこと", "エ　星に色がないこと"], answer: "正解：ア　恒星も天球上を動いていること", explain: "背景星に対する大きな位置変化は、恒星が銀河内を運動している証拠。" },
      { q: "固有運動とは何か。", choices: ["ア　恒星が天球上を1年に動く見かけの角度", "イ　恒星の色", "ウ　恒星の温度", "エ　彗星の尾の長さ"], answer: "正解：ア　恒星が天球上を1年に動く見かけの角度", explain: "背景星に対して恒星が動く見かけの角度を固有運動という。" },
      { q: "固有運動が大きい星はどんな星か。", choices: ["ア　近くて速く動く星", "イ　遠くて動かない星", "ウ　光らない星", "エ　惑星"], answer: "正解：ア　近くて速く動く星", explain: "近くて速く動く星ほど、見かけの動き（固有運動）が大きい。" }
    ]
  },
  "beta-pictoris": {
    ...
    quiz: [
      { q: "がか座β星で観測されたものはどれか。", choices: ["ア　塵円盤とその中の惑星", "イ　ブラックホールの影", "ウ　彗星の周期回帰", "エ　超新星爆発"], answer: "正解：ア　塵円盤とその中の惑星", explain: "若い星のまわりの塵円盤と、その中で育った巨大惑星が直接撮像された。" },
      { q: "がか座β星はどんな年齢の星か。", choices: ["ア　生まれて間もない若い星", "イ　寿命末期の星", "ウ　すでに消えた星", "エ　彗星"], answer: "正解：ア　生まれて間もない若い星", explain: "若い星で、まわりに惑星形成の塵円盤が広がる。" },
      { q: "塵円盤は何のゆりかごか。", choices: ["ア　惑星", "イ　彗星の尾", "ウ　ブラックホール", "エ　銀河"], answer: "正解：ア　惑星", explain: "若い星のまわりの塵円盤から惑星が生まれる。" }
    ]
  },
  "tw-hydrae": {
    ...
    quiz: [
      { q: "原始惑星系円盤のリングや隙間が示す可能性はどれか。", choices: ["ア　惑星が形成されつつあること", "イ　星が消えたこと", "ウ　銀河が衝突したこと", "エ　彗星が落ちたこと"], answer: "正解：ア　惑星が形成されつつあること", explain: "円盤内で育つ惑星が塵を集め、リングや隙間をつくると考えられる。" },
      { q: "うみへび座TW星を囲む円盤を何というか。", choices: ["ア　原始惑星系円盤", "イ　降着円盤だけ", "ウ　彗星の尾", "エ　銀河の腕"], answer: "正解：ア　原始惑星系円盤", explain: "惑星が生まれる原始惑星系円盤に、リングや隙間が刻まれる。" },
      { q: "円盤のリングや隙間はどうやって観測されたか。", choices: ["ア　高解像度の観測", "イ　肉眼", "ウ　地震計", "エ　味見"], answer: "正解：ア　高解像度の観測", explain: "高解像度観測でリングと隙間の細かい模様がとらえられた。" }
    ]
  },
  "fomalhaut": {
    ...
    quiz: [
      { q: "フォーマルハウトの偏ったリングが示すものはどれか。", choices: ["ア　見えない天体の重力作用", "イ　星の表面温度", "ウ　地球の自転", "エ　彗星の数"], answer: "正解：ア　見えない天体の重力作用", explain: "リングの偏りや鋭い縁は、近くの惑星などの重力が塵を整えた跡と考えられる。" },
      { q: "フォーマルハウトのリングの形はどうか。", choices: ["ア　縁が鋭く偏心している", "イ　完全な真円", "ウ　形がない", "エ　四角い"], answer: "正解：ア　縁が鋭く偏心している", explain: "境界が明瞭で、少し片寄った（偏心した）塵のリング。" },
      { q: "リングの形から推定できるのはどれか。", choices: ["ア　見えない惑星などの存在", "イ　恒星の名前", "ウ　地球の自転", "エ　彗星の数"], answer: "正解：ア　見えない惑星などの存在", explain: "リングの偏りや鋭い縁から、見えない天体の重力作用を推定できる。" }
    ]
  },
  "51-pegasi": {
    ...
    quiz: [
      { q: "51 Pegasiの惑星はどの方法で見つかったか。", choices: ["ア　恒星のスペクトル線の周期的なずれ（視線速度）", "イ　惑星を直接肉眼で見た", "ウ　彗星の尾から", "エ　月食から"], answer: "正解：ア　恒星のスペクトル線の周期的なずれ（視線速度）", explain: "惑星の重力で恒星がふらつき、ドップラー効果でスペクトル線が周期的にずれた。" },
      { q: "51 Pegasiが天文学史で重要なのはなぜか。", choices: ["ア　太陽型星で初めて惑星が確認されたから", "イ　最も大きい星だから", "ウ　彗星だから", "エ　光らないから"], answer: "正解：ア　太陽型星で初めて惑星が確認されたから", explain: "太陽型恒星を回る系外惑星の最初の確実な発見となった。" },
      { q: "視線速度法で恒星に起きることはどれか。", choices: ["ア　惑星に引かれて周期的にふらつく", "イ　爆発する", "ウ　色が消える", "エ　止まる"], answer: "正解：ア　惑星に引かれて周期的にふらつく", explain: "惑星の重力で恒星がふらつき、スペクトル線が周期的にずれる。" }
    ]
  },
  "wasp-39": {
    ...
    quiz: [
      { q: "WASP-39の大気の成分はどうやって調べられたか。", choices: ["ア　通過時の分光（透過分光）", "イ　惑星に着陸して採取", "ウ　彗星の尾から", "エ　北極星との比較"], answer: "正解：ア　通過時の分光（透過分光）", explain: "通過中に大気を通った光を分光し、吸収から成分を読み取った。" },
      { q: "WASP-39で検出された大気成分はどれか。", choices: ["ア　二酸化炭素", "イ　純粋な金", "ウ　液体の鉄", "エ　なにもない"], answer: "正解：ア　二酸化炭素", explain: "通過分光から、二酸化炭素など複数の化学成分が検出された。" },
      { q: "透過分光で成分が分かるのはなぜか。", choices: ["ア　大気の分子が特定の波長を吸収するから", "イ　惑星が光るから", "ウ　恒星が消えるから", "エ　地球が近いから"], answer: "正解：ア　大気の分子が特定の波長を吸収するから", explain: "大気を通った光は特定波長が吸収され、スペクトルの欠けで成分が分かる。" }
    ]
  },
  "lhs-1140": {
    ...
    quiz: [
      { q: "LHS 1140の惑星が研究対象として有利な点はどれか。", choices: ["ア　近くて観測しやすい岩石惑星だから", "イ　太陽系最大のガス惑星だから", "ウ　恒星そのものだから", "エ　彗星だから"], answer: "正解：ア　近くて観測しやすい岩石惑星だから", explain: "近傍の岩石惑星は大気や居住可能性を比較的調べやすい。" },
      { q: "LHS 1140の惑星はどんなタイプか。", choices: ["ア　岩石質の惑星", "イ　巨大ガス惑星", "ウ　恒星", "エ　彗星"], answer: "正解：ア　岩石質の惑星", explain: "近くの赤色矮星を回る、岩石質と考えられる惑星。" },
      { q: "岩石惑星が居住可能性研究に向く理由はどれか。", choices: ["ア　地球のような環境を考えやすいから", "イ　光らないから", "ウ　巨大だから", "エ　彗星に近いから"], answer: "正解：ア　地球のような環境を考えやすいから", explain: "岩石惑星は地球に似た環境を考えやすく、大気・水を探りやすい。" }
    ]
  },
  "epsilon-eridani": {
    ...
    quiz: [
      { q: "エリダヌス座ε星が比較対象として価値が高い理由はどれか。", choices: ["ア　太陽系に近く惑星と塵を詳しく見比べられるから", "イ　銀河の中心だから", "ウ　ブラックホールだから", "エ　超新星だから"], answer: "正解：ア　太陽系に近く惑星と塵を詳しく見比べられるから", explain: "近い惑星系なので、惑星と塵円盤の構造を細かく比較研究できる。" },
      { q: "エリダヌス座ε星のまわりにあるものはどれか。", choices: ["ア　惑星と複数の塵構造", "イ　何もない", "ウ　ブラックホール", "エ　超新星残骸"], answer: "正解：ア　惑星と複数の塵構造", explain: "惑星と、それを取り巻く何重もの塵の帯がある。" },
      { q: "近傍の惑星系が研究に向くのはなぜか。", choices: ["ア　構造を細かく観測できるから", "イ　遠くて暗いから", "ウ　光らないから", "エ　彗星だから"], answer: "正解：ア　構造を細かく観測できるから", explain: "近いほど惑星や円盤の構造を詳しく比較研究できる。" }
    ]
  },
  "enceladus": {
    ...
    quiz: [
      { q: "エンケラドゥスの噴出物からわかることはどれか。", choices: ["ア　氷の下に地下海があること", "イ　表面が高温の溶岩であること", "ウ　大気が酸素であること", "エ　恒星であること"], answer: "正解：ア　氷の下に地下海があること", explain: "南極から噴き出す水・塩・有機物は、氷殻の下の海の存在を示す。" },
      { q: "エンケラドゥスはどの惑星の衛星か。", choices: ["ア　土星", "イ　木星", "ウ　火星", "エ　地球"], answer: "正解：ア　土星", explain: "土星の小さな氷の衛星で、南極から噴出物を上げる。" },
      { q: "エンケラドゥスの噴出物に含まれていたものはどれか。", choices: ["ア　水・塩・有機物", "イ　純粋な金属", "ウ　溶岩だけ", "エ　なにもない"], answer: "正解：ア　水・塩・有機物", explain: "水蒸気・氷粒・塩・有機物が含まれ、生命探査の対象になった。" }
    ]
  },
  "europa": {
    ...
    quiz: [
      { q: "エウロパの氷殻の下にあると考えられるものはどれか。", choices: ["ア　塩水の海", "イ　溶けた鉄の海だけ", "ウ　濃い酸素大気", "エ　砂漠"], answer: "正解：ア　塩水の海", explain: "若い表面・亀裂・誘導磁場から、氷殻の下に導電性の塩水海があると示された。" },
      { q: "エウロパはどの惑星の衛星か。", choices: ["ア　木星", "イ　土星", "ウ　火星", "エ　太陽"], answer: "正解：ア　木星", explain: "木星の衛星で、氷殻の下に塩水海をもつとされる。" },
      { q: "エウロパの地下海の手がかりにならないものはどれか。", choices: ["ア　濃い酸素の大気", "イ　若い氷の表面", "ウ　表面の亀裂", "エ　誘導磁場"], answer: "正解：ア　濃い酸素の大気", explain: "若い表面・亀裂・誘導磁場が手がかり。酸素大気は決め手ではない。" }
    ]
  },
  "titan": {
    ...
    quiz: [
      { q: "タイタンの湖や川をつくっている液体はどれか。", choices: ["ア　液体メタン", "イ　液体の水", "ウ　溶けた鉄", "エ　液体酸素"], answer: "正解：ア　液体メタン", explain: "極寒のタイタンでは水ではなく液体メタンが湖や川をつくる。" },
      { q: "タイタンの大気の主成分はどれか。", choices: ["ア　窒素", "イ　酸素", "ウ　水素", "エ　ヘリウム"], answer: "正解：ア　窒素", explain: "窒素を主成分とする、地球より濃い大気をもつ。" },
      { q: "タイタンが研究対象として注目される理由はどれか。", choices: ["ア　地球と違う低温環境の有機化学が進むから", "イ　太陽に近いから", "ウ　高温だから", "エ　恒星だから"], answer: "正解：ア　地球と違う低温環境の有機化学が進むから", explain: "極寒でメタンが循環し、生命前の有機化学を研究できる。" }
    ]
  },
  "ganymede": {
    ...
    quiz: [
      { q: "ガニメデが太陽系の衛星で唯一もつ特徴はどれか。", choices: ["ア　固有の磁場", "イ　濃い酸素大気", "ウ　環（リング）", "エ　恒星であること"], answer: "正解：ア　固有の磁場", explain: "ガニメデは衛星で唯一、自前の磁場をもち、内部海の存在も示唆される。" },
      { q: "ガニメデは太陽系でどんな衛星か。", choices: ["ア　最も大きい衛星", "イ　最も小さい衛星", "ウ　恒星", "エ　彗星"], answer: "正解：ア　最も大きい衛星", explain: "太陽系最大の衛星で、木星をめぐる。" },
      { q: "ガニメデの固有磁場から示唆されるものはどれか。", choices: ["ア　内部海の存在", "イ　大気がないこと", "ウ　恒星であること", "エ　彗星の尾"], answer: "正解：ア　内部海の存在", explain: "磁場は内部に電気を流せる層を示し、内部海の存在も示唆する。" }
    ]
  },
  "ryugu": {
    ...
    quiz: [
      { q: "リュウグウの試料から見つかったものはどれか。", choices: ["ア　含水鉱物や有機物", "イ　純粋な金の塊", "ウ　生きた微生物の群れ", "エ　液体の海"], answer: "正解：ア　含水鉱物や有機物", explain: "持ち帰った試料から、水を含む鉱物や多様な有機物が検出された。" },
      { q: "リュウグウの試料はどうやって地球に届いたか。", choices: ["ア　探査機が持ち帰った", "イ　彗星が運んだ", "ウ　隕石として落ちただけ", "エ　届いていない"], answer: "正解：ア　探査機が持ち帰った", explain: "探査機がかけらをすくい取り、地球へ持ち帰った（サンプルリターン）。" },
      { q: "リュウグウの試料が示したことはどれか。", choices: ["ア　太陽系初期に生命材料があったこと", "イ　地球が最古であること", "ウ　月が恒星であること", "エ　彗星がないこと"], answer: "正解：ア　太陽系初期に生命材料があったこと", explain: "含水鉱物や有機物から、初期太陽系に生命材料があったと分かった。" }
    ]
  },
  "bennu": {
    ...
    quiz: [
      { q: "ベンヌの試料が示す可能性はどれか。", choices: ["ア　小惑星が地球へ水や有機物を運んだこと", "イ　地球が太陽より古いこと", "ウ　月が恒星であること", "エ　彗星が存在しないこと"], answer: "正解：ア　小惑星が地球へ水や有機物を運んだこと", explain: "炭素質物質や水に関わる鉱物から、初期地球への供給が研究された。" },
      { q: "ベンヌはどんな種類の小惑星か。", choices: ["ア　炭素質の小惑星", "イ　金属だけの小惑星", "ウ　氷の衛星", "エ　恒星"], answer: "正解：ア　炭素質の小惑星", explain: "黒い炭素質の小惑星で、初期物質をよく残す。" },
      { q: "ベンヌの試料から確認されたものはどれか。", choices: ["ア　炭素物質や水に関わる鉱物", "イ　純粋な金の塊", "ウ　生きた魚", "エ　なにもない"], answer: "正解：ア　炭素物質や水に関わる鉱物", explain: "炭素質物質や水に関係する鉱物、初期の物質が確認された。" }
    ]
  },
  "comet": {
    ...
    quiz: [
      { q: "彗星の尾ができる主な理由はどれか。", choices: ["ア　太陽に近づき氷が昇華するから", "イ　彗星が燃えているから", "ウ　地球の重力で引かれるから", "エ　他の星とぶつかるから"], answer: "正解：ア　太陽に近づき氷が昇華するから", explain: "太陽に近づくと氷が気化（昇華）し、ガスや塵を放出して尾をつくる。" },
      { q: "彗星の尾はどちらを向くか。", choices: ["ア　太陽と反対側", "イ　いつも地球の方", "ウ　進行方向の前", "エ　向きはばらばら"], answer: "正解：ア　太陽と反対側", explain: "ガスや塵は太陽の光や太陽風に押され、太陽と反対側へなびく。" },
      { q: "彗星が研究対象として重要な理由はどれか。", choices: ["ア　太陽系初期の物質を保っているから", "イ　恒星だから", "ウ　光らないから", "エ　地球を回るから"], answer: "正解：ア　太陽系初期の物質を保っているから", explain: "外縁に保存された初期物質や、地球の水・有機物の起源を探れる。" }
    ]
  },
  "halleys-comet": {
    ...
    quiz: [
      { q: "ハレー彗星が天文学史で重要なのはなぜか。", choices: ["ア　周期的な回帰が予測・確認されたから", "イ　太陽より大きいから", "ウ　恒星だから", "エ　光を出さないから"], answer: "正解：ア　周期的な回帰が予測・確認されたから", explain: "力学による軌道計算で回帰が予言され的中し、予測科学を確立した。" },
      { q: "ハレー彗星の回帰周期はおよそどれくらいか。", choices: ["ア　約76年", "イ　約1年", "ウ　約1000年", "エ　毎日"], answer: "正解：ア　約76年", explain: "およそ76年ごとに決まって戻ってくる。" },
      { q: "ハレー彗星の回帰予測に使われた考えはどれか。", choices: ["ア　ニュートン力学による軌道計算", "イ　星座の神話", "ウ　潮の満ち引きだけ", "エ　偶然"], answer: "正解：ア　ニュートン力学による軌道計算", explain: "力学で軌道を計算し、回帰の時期を予言して的中させた。" }
    ]
  },
  "io": {
    ...
    quiz: [
      { q: "イオの火山活動を支える熱源はどれか。", choices: ["ア　木星による潮汐加熱", "イ　太陽の光", "ウ　彗星の衝突", "エ　自分の核融合"], answer: "正解：ア　木星による潮汐加熱", explain: "木星の潮汐力で内部が変形・加熱され、活発な火山活動を起こす。" },
      { q: "イオの表面で起きていることはどれか。", choices: ["ア　活発な火山活動", "イ　氷が広がるだけ", "ウ　なにも起きない", "エ　海が凍る"], answer: "正解：ア　活発な火山活動", explain: "無数の活火山が硫黄や溶岩を噴き上げている。" },
      { q: "潮汐加熱とはどんなしくみか。", choices: ["ア　強い重力で変形させられ内部が温まる", "イ　太陽の光で温まる", "ウ　核融合で光る", "エ　風で冷える"], answer: "正解：ア　強い重力で変形させられ内部が温まる", explain: "木星の潮汐力で周期的に変形し、その摩擦で内部が熱くなる。" }
    ]
  },
  "north-star": {
    ...
    quiz: [
      { q: "北極星が方位の基準に使えるのはなぜか。", choices: ["ア　天の北極近くで一晩中ほぼ動かないから", "イ　最も明るい星だから", "ウ　太陽に近いから", "エ　彗星だから"], answer: "正解：ア　天の北極近くで一晩中ほぼ動かないから", explain: "自転軸の延長近くにあるため、日周運動でも位置がほとんど変わらない。" },
      { q: "北極星のまわりで他の星はどう見えるか。", choices: ["ア　北極星を中心に回って見える", "イ　まったく動かない", "ウ　消えて見えなくなる", "エ　太陽の方へ集まる"], answer: "正解：ア　北極星を中心に回って見える", explain: "日周運動で、他の星は北極星を中心にまわって見える。" },
      { q: "北極星は昔から何に使われてきたか。", choices: ["ア　方位測定や航海の基準", "イ　暦の小数計算だけ", "ウ　彗星の予報", "エ　使われていない"], answer: "正解：ア　方位測定や航海の基準", explain: "方位や航海、天球の動きの基準として長く利用された。" }
    ]
  },
  "regulus": {
    ...
    quiz: [
      { q: "レグルスが惑星観測で役立つ理由はどれか。", choices: ["ア　黄道近くにあり惑星の位置の目印になるから", "イ　惑星そのものだから", "ウ　太陽の一部だから", "エ　光を出さないから"], answer: "正解：ア　黄道近くにあり惑星の位置の目印になるから", explain: "黄道近くの恒星を背景にすると、月や惑星の位置と運動を測りやすい。" },
      { q: "レグルスはどの星座の星か。", choices: ["ア　しし座", "イ　さそり座", "ウ　おうし座", "エ　はくちょう座"], answer: "正解：ア　しし座", explain: "しし座の胸に光り、黄道のすぐ近くにある。" },
      { q: "黄道近くにあるレグルスのそばを通るものはどれか。", choices: ["ア　月や惑星", "イ　ブラックホール", "ウ　銀河団", "エ　超新星"], answer: "正解：ア　月や惑星", explain: "黄道は太陽・月・惑星の通り道なので、それらがレグルスのそばを通る。" }
    ]
  }
};
