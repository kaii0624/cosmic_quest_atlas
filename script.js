...
const CATALOG_LESSON_CONTENT = {
  "s2-star": {
    ...
    quiz: [{ q: "S2星の高速公転からわかることはどれか。", choices: ["ア　銀河中心にある巨大な質量", "イ　星の表面温度", "ウ　星座の神話", "エ　地球の自転速度"], answer: "正解：ア　銀河中心にある巨大な質量", explain: "中心を回る速さから、見えない中心天体（超巨大ブラックホール）の質量がわかる。" }]
  },
  "sgr-a-star": {
    ...
    quiz: [{ q: "いて座A*とは何か。", choices: ["ア　天の川銀河中心の超巨大ブラックホール", "イ　太陽に近い惑星", "ウ　彗星の一種", "エ　地球の衛星"], answer: "正解：ア　天の川銀河中心の超巨大ブラックホール", explain: "周囲の星の高速運動から、銀河中心に巨大質量が集中していることが分かった。" }]
  },
  "m87-star": {
    ...
    quiz: [{ q: "M87*の観測で初めて画像化されたものはどれか。", choices: ["ア　ブラックホールの影", "イ　太陽の黒点", "ウ　月のクレーター", "エ　彗星の尾"], answer: "正解：ア　ブラックホールの影", explain: "EHTが、明るいリングに縁取られた暗い影（シャドウ）を直接撮像した。" }]
  },
  "sn-1987a": {
    ...
    quiz: [{ q: "SN 1987Aで光のほかに検出されたものはどれか。", choices: ["ア　ニュートリノ", "イ　電波だけ", "ウ　なにも検出されない", "エ　太陽風"], answer: "正解：ア　ニュートリノ", explain: "中心崩壊で放たれたニュートリノが地球で検出され、超新星のしくみを裏づけた。" }]
  },
  "type-ia-supernova": {
    ...
    quiz: [{ q: "Ia型超新星が距離測定に使えるのはなぜか。", choices: ["ア　本当の明るさがほぼ一定だから", "イ　いつも同じ色だから", "ウ　動かないから", "エ　音を出すから"], answer: "正解：ア　本当の明るさがほぼ一定だから", explain: "明るさがそろう標準光源なので、見かけの暗さから距離が求められる。" }]
  },
  "proxima-b": {
    ...
    quiz: [{ q: "プロキシマbが注目される理由はどれか。", choices: ["ア　最も近い恒星系のハビタブルゾーン候補だから", "イ　太陽系で最大の惑星だから", "ウ　地球の衛星だから", "エ　彗星だから"], answer: "正解：ア　最も近い恒星系のハビタブルゾーン候補だから", explain: "最も近い恒星のまわりにある岩石惑星候補で、大気や居住可能性の研究対象になる。" }]
  },
  "trappist-1": {
    ...
    quiz: [{ q: "TRAPPIST-1の特徴はどれか。", choices: ["ア　地球サイズの惑星を多数もつ", "イ　惑星をひとつももたない", "ウ　太陽より大きく明るい", "エ　銀河の一種である"], answer: "正解：ア　地球サイズの惑星を多数もつ", explain: "赤色矮星のまわりに複数の小型惑星が並ぶ多惑星系として知られる。" }]
  },
  "kepler-186": {
    ...
    quiz: [{ q: "ケプラー186fが代表例とされる理由はどれか。", choices: ["ア　ハビタブルゾーンにある地球サイズの惑星だから", "イ　太陽系最大のガス惑星だから", "ウ　恒星そのものだから", "エ　彗星の核だから"], answer: "正解：ア　ハビタブルゾーンにある地球サイズの惑星だから", explain: "地球サイズの惑星が生命居住可能領域にもあり得ることを示した。" }]
  },
  "kepler-452": {
    ...
    quiz: [{ q: "ケプラー452の惑星を考えるときの正しい姿勢はどれか。", choices: ["ア　候補として観測で確かめて絞り込む", "イ　名前だけで地球と同じと断定する", "ウ　神話で性質を決める", "エ　明るさだけで分類する"], answer: "正解：ア　候補として観測で確かめて絞り込む", explain: "太陽型星まわりの候補であり、半径・軌道などを観測で確認して判断する。" }]
  },
  "tau-ceti": {
    ...
    quiz: [{ q: "くじら座τ星が生命探査で注目される理由はどれか。", choices: ["ア　太陽に似た近くの恒星だから", "イ　銀河の中心だから", "ウ　彗星だから", "エ　月の一種だから"], answer: "正解：ア　太陽に似た近くの恒星だから", explain: "太陽に似て近い恒星は惑星系や居住可能性を調べる比較対象になる。" }]
  },
  "hd-209458b": {
    ...
    quiz: [{ q: "トランジットで恒星の明るさはどうなるか。", choices: ["ア　わずかに暗くなる", "イ　急に消える", "ウ　明るくなる", "エ　色が緑になる"], answer: "正解：ア　わずかに暗くなる", explain: "惑星が前を横切るぶん、恒星の光がわずかに遮られて暗くなる。" }]
  },
  "large-scale-structure": {
    ...
    quiz: [{ q: "宇宙の大規模構造の説明として正しいものはどれか。", choices: ["ア　銀河が網目状（フィラメントと空洞）に分布する", "イ　銀河は完全に均一に散らばる", "ウ　銀河は一直線に並ぶ", "エ　銀河は存在しない"], answer: "正解：ア　銀河が網目状（フィラメントと空洞）に分布する", explain: "銀河はフィラメントや壁に沿って並び、間に空洞が広がる網目構造をつくる。" }]
  },
  "bullet-cluster": {
    ...
    quiz: [{ q: "弾丸銀河団がダークマターの証拠とされる理由はどれか。", choices: ["ア　光るガスと質量の中心がずれているから", "イ　星が一個もないから", "ウ　光をまったく出さないから", "エ　地球に近いから"], answer: "正解：ア　光るガスと質量の中心がずれているから", explain: "重力レンズで求めた質量分布が、高温ガスの位置と分離していた。" }]
  },
  "coma-cluster": {
    ...
    quiz: [{ q: "かみのけ座銀河団の観測が示したことはどれか。", choices: ["ア　見えない質量（ダークマター）の存在", "イ　銀河に星がないこと", "ウ　地球が宇宙の中心", "エ　太陽の温度"], answer: "正解：ア　見えない質量（ダークマター）の存在", explain: "銀河の高速運動を束ねるには見える物質では足りず、見えない質量が必要とされた。" }]
  },
  "milky-way-galaxy": {
    ...
    quiz: [{ q: "天の川銀河の構造に含まれないものはどれか。", choices: ["ア　惑星の環", "イ　円盤", "ウ　バルジ", "エ　ハロー"], answer: "正解：ア　惑星の環", explain: "銀河は円盤・バルジ・ハローからなる。惑星の環は土星などの構造で別物。" }]
  },
  "spiral-galaxy": {
    ...
    quiz: [{ q: "渦巻銀河の回転曲線からわかることはどれか。", choices: ["ア　銀河を包むダークマターの存在", "イ　星の色", "ウ　彗星の軌道", "エ　太陽の黒点数"], answer: "正解：ア　銀河を包むダークマターの存在", explain: "外縁が予想より速く回るのは、見えない質量（ハロー）が広がっているため。" }]
  },
  "distant-galaxy": {
    ...
    quiz: [{ q: "遠い銀河ほど赤方偏移が大きいことは何を示すか。", choices: ["ア　宇宙が膨張していること", "イ　銀河が冷えていること", "ウ　地球が中心であること", "エ　星が増えていること"], answer: "正解：ア　宇宙が膨張していること", explain: "距離が大きいほど速く遠ざかる関係は、宇宙全体の膨張を意味する。" }]
  },
  "sirius-b": {
    ...
    quiz: [{ q: "シリウスBのような白色矮星の特徴はどれか。", choices: ["ア　小さな半径に大きな質量をもつ高密度天体", "イ　巨大で低密度の星", "ウ　惑星の一種", "エ　彗星の核"], answer: "正解：ア　小さな半径に大きな質量をもつ高密度天体", explain: "地球ほどの大きさに太陽級の質量をもつ、高温・高密度の白色矮星。" }]
  },
  "antares": {
    ...
    quiz: [{ q: "アンタレスが赤いのに明るい理由はどれか。", choices: ["ア　半径が非常に大きいから", "イ　距離が極端に近いから", "ウ　表面が高温だから", "エ　青い光を出すから"], answer: "正解：ア　半径が非常に大きいから", explain: "赤色超巨星は表面温度が低い（赤い）が、巨大な表面積から多くの光を出す。" }]
  },
  "aldebaran": {
    ...
    quiz: [{ q: "アルデバランのような赤色巨星はどんな段階か。", choices: ["ア　主系列を終えて外層がふくらんだ段階", "イ　生まれたばかりの段階", "ウ　ブラックホールになった段階", "エ　惑星になった段階"], answer: "正解：ア　主系列を終えて外層がふくらんだ段階", explain: "中心の水素を使い終えて主系列を離れ、膨張・低温化した巨星。" }]
  },
  "capella": {
    ...
    quiz: [{ q: "連星カペラから直接測れる量はどれか。", choices: ["ア　星の質量", "イ　星の神話", "ウ　地球の年齢", "エ　彗星の数"], answer: "正解：ア　星の質量", explain: "連星の軌道（周期と大きさ）から、ケプラーの法則で恒星の質量が求められる。" }]
  },
  "procyon": {
    ...
    quiz: [{ q: "プロキオンの伴星はどうやって予測されたか。", choices: ["ア　主星の位置の揺れから", "イ　主星の色から", "ウ　彗星の尾から", "エ　月食から"], answer: "正解：ア　主星の位置の揺れから", explain: "見えない伴星の重力で主星がふらつき、その揺れから存在が予測された。" }]
  },
  "pollux": {
    ...
    quiz: [{ q: "ポルックスが示す進化段階はどれか。", choices: ["ア　太陽級の星が主系列後にふくらんだ巨星", "イ　生まれたての原始星", "ウ　超巨大ブラックホール", "エ　彗星"], answer: "正解：ア　太陽級の星が主系列後にふくらんだ巨星", explain: "太陽に近い質量の星が主系列を終え、膨張・低温化した橙色巨星。" }]
  },
  "altair": {
    ...
    quiz: [{ q: "アルタイルが扁平な形をしている理由はどれか。", choices: ["ア　高速で自転しているから", "イ　とても低温だから", "ウ　連星だから", "エ　彗星だから"], answer: "正解：ア　高速で自転しているから", explain: "速い自転の遠心力で赤道方向にふくらみ、扁平な形になる。" }]
  },
  "delta-cephei": {
    ...
    quiz: [{ q: "ケフェイド変光星で距離を測るのに使う関係はどれか。", choices: ["ア　周期と本当の明るさの関係", "イ　色と質量の関係", "ウ　自転と磁場の関係", "エ　名前と神話の関係"], answer: "正解：ア　周期と本当の明るさの関係", explain: "周期光度関係から本当の明るさが分かり、見かけと比べて距離が求められる。" }]
  },
  "polaris-cepheid": {
    ...
    quiz: [{ q: "ポラリス（北極星）のもう一つの顔はどれか。", choices: ["ア　ケフェイド変光星", "イ　ブラックホール", "ウ　彗星", "エ　銀河"], answer: "正解：ア　ケフェイド変光星", explain: "北極付近にありながら、周期的に変光するケフェイドでもある。" }]
  },
  "rr-lyrae": {
    ...
    quiz: [{ q: "こと座RR星が距離測定に使えるのはなぜか。", choices: ["ア　同型の本当の明るさがほぼ一定だから", "イ　色が毎回変わるから", "ウ　動かないから", "エ　彗星だから"], answer: "正解：ア　同型の本当の明るさがほぼ一定だから", explain: "ほぼ一定の光度をもつ標準光源なので、見かけの暗さから距離が分かる。" }]
  },
  "barnards-star": {
    ...
    quiz: [{ q: "バーナード星の大きな固有運動が示すことはどれか。", choices: ["ア　恒星も天球上を動いていること", "イ　星が完全に静止していること", "ウ　地球が動かないこと", "エ　星に色がないこと"], answer: "正解：ア　恒星も天球上を動いていること", explain: "背景星に対する大きな位置変化は、恒星が銀河内を運動している証拠。" }]
  },
  "beta-pictoris": {
    ...
    quiz: [{ q: "がか座β星で観測されたものはどれか。", choices: ["ア　塵円盤とその中の惑星", "イ　ブラックホールの影", "ウ　彗星の周期回帰", "エ　超新星爆発"], answer: "正解：ア　塵円盤とその中の惑星", explain: "若い星のまわりの塵円盤と、その中で育った巨大惑星が直接撮像された。" }]
  },
  "tw-hydrae": {
    ...
    quiz: [{ q: "原始惑星系円盤のリングや隙間が示す可能性はどれか。", choices: ["ア　惑星が形成されつつあること", "イ　星が消えたこと", "ウ　銀河が衝突したこと", "エ　彗星が落ちたこと"], answer: "正解：ア　惑星が形成されつつあること", explain: "円盤内で育つ惑星が塵を集め、リングや隙間をつくると考えられる。" }]
  },
  "fomalhaut": {
    ...
    quiz: [{ q: "フォーマルハウトの偏ったリングが示すものはどれか。", choices: ["ア　見えない天体の重力作用", "イ　星の表面温度", "ウ　地球の自転", "エ　彗星の数"], answer: "正解：ア　見えない天体の重力作用", explain: "リングの偏りや鋭い縁は、近くの惑星などの重力が塵を整えた跡と考えられる。" }]
  },
  "51-pegasi": {
    ...
    quiz: [{ q: "51 Pegasiの惑星はどの方法で見つかったか。", choices: ["ア　恒星のスペクトル線の周期的なずれ（視線速度）", "イ　惑星を直接肉眼で見た", "ウ　彗星の尾から", "エ　月食から"], answer: "正解：ア　恒星のスペクトル線の周期的なずれ（視線速度）", explain: "惑星の重力で恒星がふらつき、ドップラー効果でスペクトル線が周期的にずれた。" }]
  },
  "wasp-39": {
    ...
    quiz: [{ q: "WASP-39の大気の成分はどうやって調べられたか。", choices: ["ア　通過時の分光（透過分光）", "イ　惑星に着陸して採取", "ウ　彗星の尾から", "エ　北極星との比較"], answer: "正解：ア　通過時の分光（透過分光）", explain: "通過中に大気を通った光を分光し、吸収から成分を読み取った。" }]
  },
  "lhs-1140": {
    ...
    quiz: [{ q: "LHS 1140の惑星が研究対象として有利な点はどれか。", choices: ["ア　近くて観測しやすい岩石惑星だから", "イ　太陽系最大のガス惑星だから", "ウ　恒星そのものだから", "エ　彗星だから"], answer: "正解：ア　近くて観測しやすい岩石惑星だから", explain: "近傍の岩石惑星は大気や居住可能性を比較的調べやすい。" }]
  },
  "epsilon-eridani": {
    ...
    quiz: [{ q: "エリダヌス座ε星が比較対象として価値が高い理由はどれか。", choices: ["ア　太陽系に近く惑星と塵を詳しく見比べられるから", "イ　銀河の中心だから", "ウ　ブラックホールだから", "エ　超新星だから"], answer: "正解：ア　太陽系に近く惑星と塵を詳しく見比べられるから", explain: "近い惑星系なので、惑星と塵円盤の構造を細かく比較研究できる。" }]
  },
  "enceladus": {
    ...
    quiz: [{ q: "エンケラドゥスの噴出物からわかることはどれか。", choices: ["ア　氷の下に地下海があること", "イ　表面が高温の溶岩であること", "ウ　大気が酸素であること", "エ　恒星であること"], answer: "正解：ア　氷の下に地下海があること", explain: "南極から噴き出す水・塩・有機物は、氷殻の下の海の存在を示す。" }]
  },
  "europa": {
    ...
    quiz: [{ q: "エウロパの氷殻の下にあると考えられるものはどれか。", choices: ["ア　塩水の海", "イ　溶けた鉄の海だけ", "ウ　濃い酸素大気", "エ　砂漠"], answer: "正解：ア　塩水の海", explain: "若い表面・亀裂・誘導磁場から、氷殻の下に導電性の塩水海があると示された。" }]
  },
  "titan": {
    ...
    quiz: [{ q: "タイタンの湖や川をつくっている液体はどれか。", choices: ["ア　液体メタン", "イ　液体の水", "ウ　溶けた鉄", "エ　液体酸素"], answer: "正解：ア　液体メタン", explain: "極寒のタイタンでは水ではなく液体メタンが湖や川をつくる。" }]
  },
  "ganymede": {
    ...
    quiz: [{ q: "ガニメデが太陽系の衛星で唯一もつ特徴はどれか。", choices: ["ア　固有の磁場", "イ　濃い酸素大気", "ウ　環（リング）", "エ　恒星であること"], answer: "正解：ア　固有の磁場", explain: "ガニメデは衛星で唯一、自前の磁場をもち、内部海の存在も示唆される。" }]
  },
  "ryugu": {
    ...
    quiz: [{ q: "リュウグウの試料から見つかったものはどれか。", choices: ["ア　含水鉱物や有機物", "イ　純粋な金の塊", "ウ　生きた微生物の群れ", "エ　液体の海"], answer: "正解：ア　含水鉱物や有機物", explain: "持ち帰った試料から、水を含む鉱物や多様な有機物が検出された。" }]
  },
  "bennu": {
    ...
    quiz: [{ q: "ベンヌの試料が示す可能性はどれか。", choices: ["ア　小惑星が地球へ水や有機物を運んだこと", "イ　地球が太陽より古いこと", "ウ　月が恒星であること", "エ　彗星が存在しないこと"], answer: "正解：ア　小惑星が地球へ水や有機物を運んだこと", explain: "炭素質物質や水に関わる鉱物から、初期地球への供給が研究された。" }]
  },
  "comet": {
    ...
    quiz: [{ q: "彗星の尾ができる主な理由はどれか。", choices: ["ア　太陽に近づき氷が昇華するから", "イ　彗星が燃えているから", "ウ　地球の重力で引かれるから", "エ　他の星とぶつかるから"], answer: "正解：ア　太陽に近づき氷が昇華するから", explain: "太陽に近づくと氷が気化（昇華）し、ガスや塵を放出して尾をつくる。" }]
  },
  "halleys-comet": {
    ...
    quiz: [{ q: "ハレー彗星が天文学史で重要なのはなぜか。", choices: ["ア　周期的な回帰が予測・確認されたから", "イ　太陽より大きいから", "ウ　恒星だから", "エ　光を出さないから"], answer: "正解：ア　周期的な回帰が予測・確認されたから", explain: "力学による軌道計算で回帰が予言され的中し、予測科学を確立した。" }]
  },
  "io": {
    ...
    quiz: [{ q: "イオの火山活動を支える熱源はどれか。", choices: ["ア　木星による潮汐加熱", "イ　太陽の光", "ウ　彗星の衝突", "エ　自分の核融合"], answer: "正解：ア　木星による潮汐加熱", explain: "木星の潮汐力で内部が変形・加熱され、活発な火山活動を起こす。" }]
  },
  "north-star": {
    ...
    quiz: [{ q: "北極星が方位の基準に使えるのはなぜか。", choices: ["ア　天の北極近くで一晩中ほぼ動かないから", "イ　最も明るい星だから", "ウ　太陽に近いから", "エ　彗星だから"], answer: "正解：ア　天の北極近くで一晩中ほぼ動かないから", explain: "自転軸の延長近くにあるため、日周運動でも位置がほとんど変わらない。" }]
  },
  "regulus": {
    ...
    quiz: [{ q: "レグルスが惑星観測で役立つ理由はどれか。", choices: ["ア　黄道近くにあり惑星の位置の目印になるから", "イ　惑星そのものだから", "ウ　太陽の一部だから", "エ　光を出さないから"], answer: "正解：ア　黄道近くにあり惑星の位置の目印になるから", explain: "黄道近くの恒星を背景にすると、月や惑星の位置と運動を測りやすい。" }]
  }
};
